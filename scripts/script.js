...
async function bannarProducts() {
  let data = await getData("E-commerce-website-Task/data/bannarProducts.json");
...
async function fashionProducts() {
  let data = await getData("E-commerce-website-Task/data/fashionProducts.json");
...
async function reviews() {
  let data = await getData("E-commerce-website-Task/data/peopleReview.json")
...
async function mostViewedProducts() {
  const data = await getData("E-commerce-website-Task/data/mostViewedProducts.json");
